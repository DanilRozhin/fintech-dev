...
class OperationService:
    ...
    async def create_operation(self, operation_request: OperationRequest) -> OperationSingle:
    ...
    async def update_operation_status(self, operation_id: str, operation_status: StatusType) -> OperationSingle:
    ...
    async def get_operation_by_id(self, operation_id: str) -> OperationSingle:
